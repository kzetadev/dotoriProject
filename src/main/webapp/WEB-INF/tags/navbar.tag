			...
			<div class="collapsed navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="/board/listBoard_Post.do">전체</a></li>
							<li><a href="/board/listBoard_Post.do?str=1">자유</a></li>
							<li><a href="/board/listBoard_Post.do?str=2">후기</a></li>
							<li><a href="/board/listBoard_Post.do?str=3">동행</a></li>
